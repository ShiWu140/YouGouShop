...
const routes = [{
    ...
    path: '/register', name: 'register', meta: {
        noRequireAuth: true
    }, component: registerView,
}, {
    path: '/shoppingCart', name: 'shoppingCart', meta: {
        noRequireAuth: true
    }, component: shoppingCartView,
}, {
    path: '/buyerTrade', name: 'buyerTrade', meta: {
        noRequireAuth: true
    }, component: buyerTrade,
}, {
    path: '/classify', name: 'classify', meta: {
        noRequireAuth: true
    }, component: classify,
}, {
    path: '/goodsDetail', name: 'goodsDetail', meta: {
        noRequireAuth: true
    }, component: goodsDetail,
}, {
    path: '/deliverAddress', name: 'deliverAddress', meta: {
        noRequireAuth: true
